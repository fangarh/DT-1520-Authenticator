...
internal interface PushDecisionHistoryCipher {
    fun encrypt(plainText: String): SecurePushDecisionHistoryRecord

    fun decrypt(record: SecurePushDecisionHistoryRecord): String
}

internal class AndroidKeystorePushDecisionHistoryCipher(
    private val keyAlias: String = SecurePushDecisionHistoryRecord.DEFAULT_KEY_ALIAS
) : PushDecisionHistoryCipher {
    ...
    override fun encrypt(plainText: String): SecurePushDecisionHistoryRecord {
        return runCipherOperation("encrypt") {
            ...
            SecurePushDecisionHistoryRecord(
    ...
    private fun <T> runCipherOperation(
        ...
        try {
            ...
            throw SecurePushDecisionHistoryStorageException(
                message = "Unable to $operation push decision history payload.",
                cause = exception
            )
